...
INSERT INTO product(owner_id,name,price,description) VALUES
    ...
    (3,'21',2100,'descripcion21'),
    (3,'22',2200,'descripcion22'),
    (3,'23',2300,'descripcion23'),
    (3,'24',2400,'descripcion24'),
    (3,'25',2500,'descripcion25'),
    (3,'26',2600,'descripcion26'),
    (3,'27',2700,'descripcion27'),
    (3,'28',2800,'descripcion28'),
    (3,'29',2900,'descripcion29'),
    (3,'30',3000,'descripcion30')
;
